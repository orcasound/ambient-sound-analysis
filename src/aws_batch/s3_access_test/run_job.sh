...
################################################################################
aws s3 cp "./${save_name}.p" "s3://acoustic-sandbox/results/${save_name}.p" || error_exit "Failed to upload results to s3 bucket."
aws s3 cp "./${save_name}.txt" "s3://acoustic-sandbox/logs/${save_name}.txt" || error_exit "Failed to upload logs to s3 bucket."